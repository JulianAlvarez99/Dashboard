...
echo " 2. Ejecutar 'python3 scripts/init_db.py' para configurar la base de datos si aún no lo ha hecho."
echo " 3. Utilizar un manejador de procesos como Supervisor, PM2 o Systemd para servir la aplicación en producción con Uvicorn o Gunicorn."
echo "========================================="